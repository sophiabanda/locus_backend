...
password = 'asdfasdf'
mobile = '5555555555'
first_name, last_name = %w[anonymous user]
anonymous_user = User.find_or_create_by(mobile: mobile)
anonymous_user.first_name = first_name
anonymous_user.last_name = last_name
anonymous_user.password = password
